...
are its facets.  Following the combinatorial conventions, every nonempty
simplicial complex has the empty set as a face.
...
Given a monomial ideal $J$, there are several algorithms return a labelled
