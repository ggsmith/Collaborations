...
\end{lstlisting}
\begin{lstlisting}[xleftmargin=10pt, aboveskip=1.5pt, belowskip=1.5pt]
i39 : $Δ$ = simplicialComplex{x_0*x_1*x_2, x_2*x_3}
\end{lstlisting}
\begin{lstlisting}[xleftmargin=10pt, aboveskip=1.5pt, belowskip=1.5pt]
...
\end{lstlisting}
\begin{lstlisting}[xleftmargin=10pt, lineskip=-10pt, aboveskip=1.5pt, belowskip=1.5pt]
o13 = 0 : cokernel | y_0y_3 y_0y_2 y_0y_1 y_1y_2y_3 |
...
Given a monomial ideal $J$, there are several algorithms that produce a
labelled simplicial complex $\Delta$ such that chain complex $C(\Delta)$ is a
free resolution of the quotient $R/J$.  We exhibit a few.

the $I$-homogenization of
...
\end{lstlisting}
  %
The Scarf simplicial complex of $I$ starts with the labelled $4$-simplex and
removes any faces $F,F'$ such that $m_F = m_{F'}$. The $I$-homogenization of
the Scarf simplicial complex is the Scarf chain complex. It is often the case
that the Scarf chain complex is not a free resolution of $S/I$, but when it is
a resolution, it is minimal, see Lemma~3.1 in \cite{BPS}.
  %
\begin{lstlisting}[basicstyle={\ttfamily \scriptsize}, xleftmargin=-23pt]
